...
public class JdbcConnection {
	...
	static {
		try {
			// 读取配置文件中的jdbc参数信息
			ResourceMap ims_rm = new ResourceMap(ItemPath.getItemPathBSorCS()+"/classes/jdbc");
	...
	static {
		try {
			ResourceMap yc_rm = new ResourceMap(ItemPath.getItemPathBSorCS()+"/classes/jdbc");
	...
	public static void main(String[] args) {
       	ResourceMap rm = new ResourceMap(ItemPath.getItemPathBSorCS() + "/classes/jdbc");
